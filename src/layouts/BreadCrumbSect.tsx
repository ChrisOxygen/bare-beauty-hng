...
function BreadCrumbSect() {
  return (
    <>
      <div className="mobile-breadcrumb-block block">
        <div className="box-container ">
          <div className="mobile-breadcrumb-block__content-area">
        ...
        <div className="box-container ">
          <div className="breadcrumb-block__content-area">
            ...
            <span className="page-desc">
              ...
              of targeted face serums. These lightweight, fast-absorbing
              formulas are packed with potent active ingredients that address
              specific concerns like fine lines, wrinkles, hyperpigmentation,
              and dullness.
            </span>
            <menu className="breadcrumb-list">
              <li className="breadcrumb-list__item">
